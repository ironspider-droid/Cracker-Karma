...
const analyzeCrackerFlow = ai.defineFlow(
    ...
    async (input) => {
        const prompt = ai.definePrompt({
            name: 'analyzeCrackerPrompt',
            input: { schema: AnalyzeCrackerInputSchema },
            output: { schema: AnalyzeCrackerOutputSchema },
            prompt: `You are a firecracker expert. Analyze the provided image.
